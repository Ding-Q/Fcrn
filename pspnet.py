...
parser.add_argument('-save_img_path', type=str, default='./results_pspnet')
parser.add_argument('-test_img_path', type=str, default='../test1/lab_dete_pspnet')
parser.add_argument('-model_path', type=str, default='./model_fcrn/pspnet.pkl')
...
IMG_CUT = opt.img_cut
writer = SummaryWriter('./runs2/pspnet')
...
fcrn_scheduler = optim.lr_scheduler.StepLR(fcrn_optimizer,step_size=300,gamma = 0.5)
